...
public class DiameterOfBinaryTree {
    ...
    public static int diameter(Node node) {
        ...
        dia = 0; // initializing diameter;
        diameterHelper(node); // calling helper function
        return dia;    // diameter
    }
    ...
    public static int diameterHelper(Node node) {
        // write your code here
        if(node == null) {
            return -1; // return -1 to find in terms of edges or return 0 for nodes : height/diameter
        }
